...
- Ensuring that a service is up and running is a shared responsibility (shared responsibility model)
...
- Aims to help creating an application quickly without managing the underlying infrastructure.
  - E.g. for a web app you don't need to install an operating system, web server, or even system updates.
...
- SaaS: user justt uses the software.
