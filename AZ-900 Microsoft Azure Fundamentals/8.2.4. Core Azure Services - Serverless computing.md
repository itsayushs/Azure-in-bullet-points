...
- You can deploy the project in an environment that isn't serverless for more flexibility with [Azure functions host](https://github.com/Azure/azure-functions-host)
